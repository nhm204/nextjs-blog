  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      <div className="relative overflow-hidden shadow-md pb-80 mb-6">
        <img src={post.image.url} alt="post-image" className="object-center absolute h-80 w-full object-contain shadow-lg rounded-t-lg lg:rounded-lg" />
      </div>
      ...
      <p className="text-justify text-lg text-gray-700 font-normal px-4 lg:px-8 mb-8">
        {post.excerpt}
      </p>
